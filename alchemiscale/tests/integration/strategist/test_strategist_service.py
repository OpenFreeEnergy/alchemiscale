...
class TestStrategistService:
    ...
    @pytest.fixture
    def preloaded_network_with_strategy(self, n4js_fresh, s3os_server_fresh, network_tyk2, scope_test):
        ...
        transformation_sks = n4js.get_network_transformations(network_sk)[:2]  # Just first 2
        task_sks = n4js.create_tasks(transformation_sks * 3)  # 3 tasks per transformation
    ...
    def test_execute_strategy_basic(self, strategist_service, preloaded_network_with_strategy):
    ...
    def test_strategy_with_dormant_state(self, strategist_service, preloaded_network_with_strategy):
    ...
    def test_strategy_task_creation_and_actioning(self, strategist_service, preloaded_network_with_strategy):
    ...
    def test_strategy_error_handling(self, strategist_service, preloaded_network_with_strategy):
    ...
    def test_weights_to_task_counts_linear(self, strategist_service):
        ...
        weights = {
            ScopedKey.from_str("Transformation-test_org-test_campaign-test_project-abc123"): 0.5,
            ScopedKey.from_str("Transformation-test_org-test_campaign-test_project-def456"): 1.0,
            ScopedKey.from_str("Transformation-test_org-test_campaign-test_project-ghi789"): 0.0,
            ScopedKey.from_str("Transformation-test_org-test_campaign-test_project-jkl012"): None,
        }
